...
public class TextLine implements TextSequence {
	...
	public void drawRotated(PDPageContentStream contentStream,
							Position upperLeft,
							Alignment alignment,
							...
							double paragraphHeight) throws IOException {
		...
		double centerX = paragraphPosition.getX() + availableLineWidth / 2;
		double centerY = paragraphPosition.getY() - paragraphHeight / 2;
		...
		drawAlignedWithOffset(contentStream, alignment, availableLineWidth, drawListener, x, y);
	...
	public void drawAlignedWithOffset(PDPageContentStream contentStream,
									  Alignment alignment, float availableLineWidth,
									  DrawListener drawListener, float x, float y) throws IOException {
